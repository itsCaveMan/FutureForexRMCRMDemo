!function() {
    ...
    class s {
        ...
        on(t, e) {
            ...
            return this.events.on(`vanilla-rss/${t}`, e),
            this
        }
        render() {
            return new Promise(async(t,e)=>{
                ...
                if (this.target.append(i.layout),
                0 !== i.entries.length) {
        ...
        async _fetchFeed(t) {
            if (this.options.fetchFeed)
                return await this.options.fetchFeed(t);
        ...
        _generateHTMLForEntries() {
            ...
            return this.entries.forEach((e,i)=>{
                ...
                let o;
                s && n ? i >= s && i <= n && this._isRelevant(e, t.entries) && (o = this._evaluateStringForEntry(this.options.entryTemplate, e),
                t.entries.push(o)) : this._isRelevant(e, t.entries) && (o = this._evaluateStringForEntry(this.options.entryTemplate, e),
                t.entries.push(o))
            }
            ),
            this.options.entryTemplate ? t.layout = this._wrapContent(this.options.layoutTemplate.replace("{entries}", "<entries></entries>")) : t.layout = this._wrapContent("<div><entries></entries></div>"),
            t
        }
        _isRelevant(t, e) {
        ...
        _getTokenMap(e) {
            ...
            return {
                ...
                bodyPlain: function(e) {
                    for (var i = e.content.replace(/<script[\\r\\\s\S]*<\/script>/gim, "").replace(/<\/?[^>]+>/gi, ""), s = 0; s < t.length; s++)
                ...
                mediaContent: function(t) {
                    try {
                        // return t.content.match(/(<media.*?>)/gi)[0].match(/src=["'](.*?)["']/)[1]
                        return "URL"
                    } catch (t) {
                        return ""
                    }
        ...
        _getValueForToken(t, e) {
            var i = this._getTokenMap(e)
              , s = i[t.replace(/[\{\}]/g, "")];
            if (void 0 !== s)
                return "function" == typeof s ? s(e, i) : s;
